...
\cite{doi:10.1094/PHYTO-11-15-0284-R} first demonstrated genetic tolerance and the heritability 
of crown dieback and collar-lesion symptom expression. In the three French provenances sampled,
\cite{doi:10.1094/PHYTO-11-15-0284-R} found no evidence for regional tolerance. \cite{doi:10.1094/PHYTO-11-15-0284-R}.
...
profiling which metabolites predict resistance \cite{nemesio2020canditate, nemesio2020metabolomics, sidda2020diversity, chaudhary2020identification}.
...
and collar lesions. In this scheme, forest managers would inspect disease severity to record disease progression over time. Forest
managers should then record genetically resistant trees to cultivate for future timber production. In addition, 
