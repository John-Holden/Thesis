...
fronts, following from their fat-tailed leptokurtic nature and subsequent scale-variance. In particular,
...
\begin{figure}
    ...
    \caption{Wheat strip rust prevalence with distance for three data sources, taken from \cite{severns2019consequences}.
    }
...
Namely, the authors constructed wheat plantations and artificially introduced WSR to measure its prevalence over time. 
...
More specifically, we see that WSR induces and progressively smaller number of lesions with distance, e.g.  
the infection could arise up to $10\mathrm{km}$ away from the source, illustrated by triangles in the lower right hand corner.
