...
as percolation. Beginning with a simple $SIR$ framework was already well-established around the time percolation
theory was conceived \cite{baily1975mathematical}. Owing to an implicit spatio-temporal construction,
...
Although recent work has called travelling waves into question, as we discuss more below, 
...
Hence, the two terms in Equation \ref{eq:fkpp} describe a populations
the logistic growth ($ru(1 - u/K)$) and spread ($\mathcal{D}\nabla u$).
...
The FKKP model has close connections to alternative travelling-wave models examined in the context of
plant disease epidemics \cite{heesterbeek1987modelling, van1988focus}. Although, in the context of plant disease models, 
travelling wave solutions typically emerge from the inclusion of short-range exponentially-bounded\footnote{
...
Therefore, at first glance, the reaction diffusion (RD) FKPP travelling wave presents a simple, 
intuitive place to begin modelling the spread of disease through a population of trees.
However, research is now suggesting that disease fronts that propagate through LDD accelerate,
in contrast to the constancy predicted by Equation \ref{eq:fkpp_vel}.
