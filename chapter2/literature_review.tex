...
the logistic growth and spread, $ru(1 - u/K)$ and $\mathcal{D}\nabla u$ respectively.
...
\begin{figure}
    ...
    \caption{Wheat strip rust prevalence with distance shown for three data sources, taken from \cite{severns2019consequences}.
             The authors found that disparate disease prevalence studies wheat strip rust at different spatial scales could
             be fitted against a common power law\textemdash displayed in the plots bottom left corner. 
    }
