...
Accordingly, Van der Plank adapted Equation \ref{van-plank} as follows:
\begin{equation}
\label{van-plank-incubation}
    \frac{dI}{dt} = RI_{t-p}(1 - I_{t})
\end{equation}
...
and $R$ denotes the `basic' infection rate. As Plank argues, one usually seeks
...
from Equation \ref{eq:R0-effective}.
 ...
 % I think this was proved, cited in SEnImR model 
 
%  Here, the parameter $r$ provides a course-grained summary of the complex interaction between host, 
