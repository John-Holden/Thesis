...
Although, scientists, policymakers and stakeholders can cooperate to prevent the spread of tree disease. 
...
However, a plethora of challenges complicate an effective on-the-ground response. 
...
In particular, policymakers can lead a variety of control initiatives to impede the spread of disease to meet this complicated challenge \cite{pests-intro, Gilligan-disease-management}. 
Effectively controlling the core epidemic drivers can improve 
the climate, economic resource allocation, and ecological function \cite{ash-dieback-costs, freer2017tree, boyd2013consequence, tyrvainen2005benefits}. 
Strategies to increase pathogen resilience generally include, thinning host densities \cite{pietzsch2021effect, resiliency-density-reductions} and cultivating genetically diverse distributions \cite{doi:10.1094/PD-89-0969, genetic-heterogeneity, huang1980importance}.
