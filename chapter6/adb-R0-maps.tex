...
The low infectivity map ($\beta^*=250$) shown in Figure \ref{fig:adb-comparison}(b) looks significantly different from the ADB observations in (a).
...
Increasing infectivity to $\beta^*=650$ in Figure \ref{fig:adb-comparison}(c) produces map with more similarities to the FC survey data. 
In particular, visual assessments reveal a comparable degree of patchiness/fragmentation between maps.   
