...
As such, a modelled distribution of ash that covers the whole of Great Britain was used to parameterise host densities.
...
Consequently, combining our small-scale $SEIR$ model with data given by \cite{hill.data} demonstrates a novel use of modelled abundance data.
