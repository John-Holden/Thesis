...
\begin{figure}
    \centering
    \includegraphics[scale=0.45]{chapter6/figures/comparisnos-adb-map.pdf}
    \caption{Comparisons between the Forestry Commissions ADB survey data and three example $R_0$-maps from low to high infectivities.
    ...
    (d) A high value of $\beta^*=1000$ appears  
