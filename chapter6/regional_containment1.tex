...
However computing tree mortality requires simulations to run over a number of years, which not considering host-demography is problematic.
...
To overcome these challenge, epidemic severity in the system will be categorised by a basic reproduction number $R_0$.
...
Initial conditions play a minor role in shaping the value of $R_0$ and give rise to different behaviour between models. 
In this section, initial conditions will be investigated for $\phi_1$-ga and $\phi_2$-pl, variations in the sporulation played a negligible role.
...
Therefore, going forward, ensemble simulations of $R_0$ will be chosen to evolve from IC1.
