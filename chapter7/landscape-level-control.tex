...
This Chapter outlines a novel method to disrupt epidemic connectivity in the host distribution, described through sections \ref{sec:fragmentation-method-1}-\ref{sec:fragmentation-method-2}.
...
\section{Discussion and speculative research}
...
Here, the method presented to identify high-risk areas might also find applications in enhanced monitoring and surveillance\textemdash discussed in section \ref{sec:modelling-and-policy}.
