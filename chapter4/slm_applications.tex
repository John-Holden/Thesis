...
Moreover, the channel permits an improved (more intuitive) `centre of mass' metric (\acrshort{com}), based on the mean infectious tree displacement from the origin:
\begin{equation}
