...
\subsection{$R_0$-maps for $SEIR$ variants}

\label{a:R0-map-construction}
\begin{figure}
    \centering
    \includegraphics[scale=0.10]{appendix/figures/A-ch6-R0-vs0-L.pdf}
    \caption{placeholder for Gaussian and sporulation function R0 map construction.}
    \label{fig:a-R0-maps-SEIR-variants}
\end{figure}
