...
Most intriguingly, deriving a spatially-explicit analytic expression of $R_0$ in Chapter \ref{ch5:dispersal-model} led to an `entire function', well-known in complex analysis \cite{abramowitz1948handbook}. 
